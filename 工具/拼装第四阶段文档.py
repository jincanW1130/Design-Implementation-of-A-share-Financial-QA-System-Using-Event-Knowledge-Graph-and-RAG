...
| 上级依据 | 《02-项目执行总控文档》**v2.8**（版本链：编写本文件时依据 v2.5；v2.6 已固化 Embedding 模型与数据集版本级属性；v2.7 为前五阶段审核后的问题修复登记，其中 第9.1节 补登记 answer.is_graph_extended，与本文件 4.4.1 的字段表一致；v2.8 为第 6 阶段收口时按《15》第2.4节（二）追加的注记登记——抽取所用的模型与 Prompt 版本属上游数据生产参数、不并入 第12.4节 的七项，本文件所引条文的口径均未改变）：第6.2节 六个功能模块、第7节 非功能需求、第8节 系统总体架构与不引入的技术、第9节 数据设计概要（六张表／本体／向量索引）、第10节 时间维度、第11节 技术路线、第12节 混合检索策略与实验方案、第13节 最终回答形态与证据追溯、第15节 第四章目录 |
...
| 上游 | 《02-项目执行总控文档》v2.8（版本链：编写本文件时依据 v2.5；v2.6 固化 Embedding 模型与数据集版本级属性；v2.7 为前五阶段审核后的问题修复登记；v2.8 为第 6 阶段收口时的注记登记，抽取配置属上游数据生产参数、不并入 第12.4节 的七项，所引条文口径未改变）：第6.2节、第8节、第9节、第10节、第11节、第12节、第13节、第15节 第四章（口径来源，本文件只引用、不改动） |
